...
const Checkbox = () => {
  return (
    <div className="flex items-center space-x-3 m-5.5">
      <label className="group flex items-center cursor-pointer">
        {/* Hidden Checkbox */}
        <input className="hidden peer" type="checkbox" />

        {/* Custom Checkbox UI */}
        <span className="relative w-8 h-8 flex justify-center items-center bg-gray-100 border-2 border-gray-400 rounded-md shadow-md transition-all duration-500 peer-checked:border-green-700 peer-checked:bg-green-700 peer-hover:scale-105">
